    ...
    <x-slot name="form">
        ...
        <div class="col-md-8">
            <div class="form-group has-icon-left">
                <div x-data="{photoName: null, photoPreview: null}" class="position-relative">
                ...
                <div class="avatar avatar-xl me-3" x-show="! photoPreview">
                    <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" srcset="">
                </div>

                <!-- New Profile Photo Preview -->
                <div class="avatar avatar-xl me-3" x-show="photoPreview" style="display: none;">
                    <img x-bind:style="'background-image: url(\'' + photoPreview + '\');'" srcset="">
                </div>
